...
with (pc, plot(Time,Global_active_power , pch=".", type="o"   , ylab = "Global Active Power" , xlab=""))

with(pc,plot(Time,Voltage , type="l", pch='.'  , ylab="Voltage" , xlab="datetime"))
...
with (pc, plot(Time,Global_reactive_power , pch=".", type="o"  , ylab = "Global Reactive Power" , xlab="datetime"))
dev.off() 
